...
if [ -n "$QTDIR" ]; then
    ...
    cmake -DCMAKE_PREFIX_PATH="/usr/lib/x86_64-linux-gnu/cmake/Qt6" -Dappimage=ON -DINSTALL_ROOT=$TARGET_DIR ..
fi
...
cp -v ../platforms/linux/qlcplus5.desktop $TARGET_DIR/qlcplus.desktop
